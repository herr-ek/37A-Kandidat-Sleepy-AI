...
"""
Train a single classical ML model (KNN / RandomForest / SVM) on the SaO2 feature files. Uses a predefined train/test/validate split defined in set_distribution/training_set.txt and test_set.txt, which should be generated by running jobs/generate_sets.py.
params:
